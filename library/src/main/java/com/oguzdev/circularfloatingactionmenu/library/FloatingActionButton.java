...
public class FloatingActionButton extends FrameLayout {
    ...
    public static final int POSITION_TOP = 9;
    public static final int POSITION_BOTTOM = 10;
    public static final int POSITION_LEFT = 11;
    public static final int POSITION_RIGHT = 12;
    public static final int POSITION_CENTER = 13;
