...
public class FloatingActionMenu {
    ...
    private Point calculateItemPositions() {
        ...
        RectF area = new RectF(center.x - radiusX, center.y - radiusY, center.x + radiusX, center.y + radiusY);
    ...
    public static class Builder {
        ...
        public Builder(Context context, boolean systemOverlay) {
            ...
            // Default settings
            radiusX = context.getResources().getDimensionPixelSize(R.dimen.action_menu_radius);
            radiusY = context.getResources().getDimensionPixelSize(R.dimen.action_menu_radius);
            startAngle = 180;
            endAngle = 270;
        ...
        public Builder setRadius(int radiusX, int radiusY) {
            this.radiusX = radiusX;
            this.radiusY = radiusY;
            return this;
        }
